...
public class DoubleLinkedList<T extends Comparable<T>> implements IList<T>, Iterable<T>, Comparator<T> {
	...
	/**
	 * @return true si la lista estï¿½ ordenada de menor a mayor, false de lo contrario.
	 */
	 ...
	 * Implementaciï¿½n tomada de "A practical guide to algorithms and data structures using java"
	 */
