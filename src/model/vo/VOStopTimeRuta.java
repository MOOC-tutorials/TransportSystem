...
public class VOStopTimeRuta implements Comparable<VOStopTimeRuta>{
	 ...
	 */
	public VOStopTimeRuta( VOStopTime stopTime, int routeId ){
	...
	public String toString(){
		return "StopID: " + stopId + " TripId: " + tripId + " ArrivalTime: " + arrivalTime + "routeID: " + routeId ;
	}

	@Override
	public int compareTo(VOStopTimeRuta pVOStopTimeRuta) {
		return  arrivalTime.compareTo(pVOStopTimeRuta.getArrivalTime());
	}
}
